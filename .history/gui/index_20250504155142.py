...
def open_format():
    ...
    # Modify pdfToxml to accept a parameter instead of using sys.argv
    def modified_pdfToxml(pdf_path):
        import xml.etree.ElementTree as ET
        
        # Set output path
        output = r"valid xml\guifilled.xml"
        
        # Call the existing logic with the provided pdf_path
        ...
        # Rest of the pdfToxml function...
        # (keeping the existing logic but omitting it here for brevity)
        
        # Run the existing pdfToxml logic with our pdf_path
        # ...
        
        # Return the output path
        return output
    
    # Run the modified function and get the output path
    try:
        output_path = modified_pdfToxml(pdf_path)
        # Show a success message with the path
        messagebox.showinfo("Success", f"XML file created successfully at: {output_path}")
    except Exception as e:
        # Show error message if something goes wrong
        messagebox.showerror("Error", f"Failed to create XML: {str(e)}")
