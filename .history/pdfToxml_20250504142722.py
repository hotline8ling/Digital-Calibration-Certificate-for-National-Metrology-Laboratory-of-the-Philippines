...
pdf_path = r"C:\Users\ADMIN\Downloads\tabular-output.pdf"
...
for i, tbl in enumerate(table_columns):
    print(f"Table {i+1}")
...
# resp3: use empty strings if keys are missing
...
# …existing code up to # 7) measurementResults …
